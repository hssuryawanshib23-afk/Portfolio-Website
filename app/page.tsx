...
const BEATS = [
  ...
  },
  {
    ...
    label: "Interests",
    title: "ROOTS",
    subtitle: "love VLSI, Control Systems, and the hardware t lovehat powers the future (studying as part of academics) :). \nObsessed with open source, new tech, extending research and how systems actually fail at scale.",
  ...
  },
  {
    ...
    subtitle: "Transformers from scratch. RAG pipelines. \n Voice models. Lie detector. Portfolio Optimization. . . \n  Things that shouldn't work until they do.",
    detail: "Building the Rural Insurance Assistant and Quant Finance models.",
    cta: null as string | null,
